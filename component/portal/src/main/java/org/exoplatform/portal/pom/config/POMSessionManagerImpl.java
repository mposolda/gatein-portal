 ...
 * @version $Revision$
 */
public class POMSessionManagerImpl implements POMSessionManager, Startable {
    ...
    /** . */
    private TaskExecutionDecorator executor;

    /** . */
    private final RepositoryService repositoryService;

    public POMSessionManagerImpl(RepositoryService repositoryService, ChromatticManager manager, CacheService cacheService) {
        //
    ...
    protected ExoCache<ScopedKey<?>, Object> getCache() {
        return cache;
    }

    protected void setTaskExecutor(TaskExecutionDecorator executor) {
